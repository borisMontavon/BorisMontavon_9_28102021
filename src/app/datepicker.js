...
class Datepicker {
    constructor(host, s) {
        ...
        document.addEventListener("click", e => {
            ...
            else if (document.getElementById("datepicker-frame") != null &&!e.path.includes(document.getElementById("datepicker-frame"))) {
                show(false);
            }
        });
            ...
            // If data is year
                ...
                for (let y = 0; y < 3; y++) {
                    ...
                    for (let x = 0; x < 4; x++) {
                        ...
                        if ((t.firstdate != undefined ? day.getTime() >= new Date(t.firstdate).setDate(1) : true) &&
